...
Ext.onReady(function() {
	...
	if(ip == "" || jmxPort == ""|| contextName == ""|| httpPort == ""){
	...
	var analysisWindow = Ext.create('Ext.window.Window', {
	    ...
	    items: [{
	        ...
	        autoEl : {
	            tag : "iframe",
	            src : "http://" + ip + ":8089/polliwog/tomcatlogs/monthly-summary.html"
	        }
    	}]
	});
	...
	var panel = Ext.create('Ext.panel.Panel', {
		...
		width : 420,
		height : 700,
		items : [formPanel, analysisPanel, controlPanel, customMonitorPanel]
	});
